...
class SuperadminOrganizationController extends Controller
{
    public function index(): Response
    {
        ...
        $organizations = Organization::query()
            ...
            ->map(fn (Organization $organization) => [
                ...
                'senangpay_environment' => $organization->senangpay_environment,
    ...
    public function update(Request $request, Organization $organization): RedirectResponse
    {
        ...
        $data = $request->validate([
            ...
            'bayarcash_api_token' => ['nullable', 'string', 'max:4096'],
            'bayarcash_portal_key' => ['nullable', 'string', 'max:4096'],
            'bayarcash_secret_key' => ['nullable', 'string', 'max:4096'],
            'bayarcash_environment' => ['nullable', 'in:sandbox,live'],
            'payment_gateway' => ['nullable', 'in:bayarcash,doku,senangpay'],
            ...
            'senangpay_secret_key' => ['nullable', 'string', 'max:500'],
            'senangpay_environment' => ['nullable', 'in:sandbox,production'],
        ...
        $payload = [
            ...
            'max_age' => ($data['max_age'] ?? null) !== null ? (int) $data['max_age'] : null,
            ...
            'senangpay_merchant_id' => $data['senangpay_merchant_id'] ?? null,
            'senangpay_secret_key' => $data['senangpay_secret_key'] ?? null,
            'senangpay_environment' => $data['senangpay_environment'] ?? 'sandbox',
