...
Route::middleware(['auth', 'verified', 'profile_complete'])->group(function () {
    ...
    Route::middleware('role:Superadmin|Admin')->group(function () {
        ...
        Route::get('/admin/broadcasts/{broadcast}/logs', [BroadcastController::class, 'logs'])->name('admin.broadcasts.logs');
    ...
    Route::middleware('role:Superadmin')->group(function () {
        ...
        // Mesti didaftar sebelum route wildcard {onboardingSlide} supaya
        // "login-branding" tidak ditafsir sebagai ID slide.
        Route::match(['put', 'post'], '/superadmin/onboarding/login-branding', [OnboardingSlideController::class, 'updateLoginBranding'])->name('superadmin.onboarding.login-branding.update');
        // Borang hantar POST + _method=put, jadi kedua-dua verb perlu diterima.
        Route::match(['put', 'post'], '/superadmin/onboarding/{onboardingSlide}', [OnboardingSlideController::class, 'update'])->name('superadmin.onboarding.update');
