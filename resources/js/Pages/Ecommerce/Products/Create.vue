        ...
        <div class="mx-auto max-w-4xl px-4 py-4 md:px-6 md:py-6">
            <div class="rounded-3xl border border-gray-100 bg-white p-4 shadow-sm sm:p-6">
                <form class="space-y-4" @submit.prevent="submit">
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold text-gray-500">Gambar Utama (optional)</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold text-gray-500">Gambar Tambahan (optional, boleh pilih lebih dari satu)</label>
