        ...
        <div class="min-h-screen bg-[#F5F7F6] py-6 md:py-10 overflow-x-hidden">
            ...
            <!-- ═══ ACTION BUTTONS ═══ -->
                <div class="flex gap-3 print:hidden">
                    ...
                    <a :href="route('member.card.letter')" class="flex-1 flex items-center justify-center gap-2 rounded-2xl bg-gray-900 px-4 py-3 text-xs font-semibold text-white shadow-sm hover:bg-gray-800 transition active:scale-95">
