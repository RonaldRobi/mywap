                                ...
                                <td class="px-4 py-3">
                                    <div class="flex flex-wrap items-center gap-2">
                                        ...
                                        <a
                                            ...
                                            class="inline-flex items-center gap-1 rounded-lg bg-gray-900 border border-gray-800 px-2.5 py-1 text-xs font-semibold text-white hover:bg-gray-800 transition"
                                        >
